...
//      Crear una struct con otro struct
//    Json::Value jsonObject;
//    jsonObject["variables"][0]["nombre"] = "num2";
//    jsonObject["variables"][0]["valor"] = "h";
//    jsonObject["variables"][0]["tipoDeDato"] = "char";
...
//
//    Json::Value jsonObject1;
//    jsonObject1["nombreDeStruct"] = "estructura2";
//    jsonObject1["asignarUnStruct"] = "estructura";
//
//    std::string jsonString1 = VariableManager::jsonToString(jsonObject1);
//    VariableManager::getInstance()->createStruct(jsonString1);
//    std::cout<<MemoryPool::getInstance()->ObjectCount<<std::endl;
//
//    Json::Value jsonObject4;
//    jsonObject4["nombre"] = "num2";
//    jsonObject4["nombreDeStruct"] = "estructura2";
//
//    std::string jsonString4 = VariableManager::jsonToString(jsonObject4);
//    VariableManager::getInstance()->getStructAttribute(jsonString4);
